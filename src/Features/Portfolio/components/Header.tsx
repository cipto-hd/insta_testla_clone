...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-30 w-full -mb-20 text-gray-800 bg-gray-100 border-b shadow-md dark:bg-gray-800 dark:text-gray-100">
      <div className="container relative flex items-center justify-between w-full h-20 overflow-x-clip">
        ...
        <ul
          className={
            ...
            "absolute right-0 md:inline-flex md:static md:right-auto z-50 flex flex-col items-center gap-2 bg-gray-100 border md:border-none md:rounded-none rounded-md shadow-md md:shadow-none dark:bg-gray-800 top-16 md:flex-row transition-transform duration-300 ease-in-out"
          }
        >
        ...
        <div className="absolute z-50 flex items-center justify-center gap-2 cursor-pointer right-2 md:static">
          ...
          <div className="md:hidden" onClick={() => dispatch(toggleSideMenu())}>
            {isSideMenuOpen ? (
